...
class TestPedestal(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._pedtest = PedPerkeo(self._data, bplot_fit=True, custom_hist_par=self._custom_bins)
    ...
    def test_ped_correction(self):
        ...
        corr_class = CorrPerkeo(measurement, mode=2, ped_arr=self._pedestals, custom_pmt_hist_par=custom_bins)
